...
var WindowOptionsSchema = z.object({
...
// src/webgpu.ts
function enableWebGPU(app6, config) {
  if (!app6.isReady()) {
    app6.commandLine.appendSwitch("enable-features", "Vulkan,UseSkiaRenderer");
    app6.commandLine.appendSwitch("enable-unsafe-webgpu");
    if (config.forceSoftware) {
      app6.commandLine.appendSwitch("disable-gpu");
    }
